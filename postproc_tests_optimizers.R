...
### user data
#filenames <- c("normal_search_ackley_5_sigma_0.1.RData","normal_search_ackley_5_sigma_1.RData","normal_search_ackley_5_sigma_10.RData")
...
filenames <- c("egoSimple_ackley_2.RData","ego_NS_ackley_2.RData")
